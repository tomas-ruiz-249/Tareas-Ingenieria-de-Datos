...
select d.nombre as 'departamento', e.nombre as 'empleado' from departamento d left join empleados e on e.id_departamentoFK = d.id_departamento;

#muestre el total de empleados por cada departamento
select id_departamentoFK as 'id del departamento' , count(*) as 'cantidad de empleados' from empleados group by id_departamentoFK; 